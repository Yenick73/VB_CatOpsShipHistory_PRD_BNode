...
Partial Public NotInheritable Class sht_FG_OS
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_FG_OS", "sht_FG_OS")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_FG_OS As sht_FG_OS
    
    Friend Shared Property sht_FG_OS() As sht_FG_OS
        Get
            Return _sht_FG_OS
        End Get
        Set
            If (_sht_FG_OS Is Nothing) Then
                _sht_FG_OS = value
            Else
