...
Partial Public NotInheritable Class sht_Platform
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_Platform", "sht_Platform")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_Platform As sht_Platform
    
    Friend Shared Property sht_Platform() As sht_Platform
        Get
            Return _sht_Platform
        End Get
        Set
            If (_sht_Platform Is Nothing) Then
                _sht_Platform = value
            Else
