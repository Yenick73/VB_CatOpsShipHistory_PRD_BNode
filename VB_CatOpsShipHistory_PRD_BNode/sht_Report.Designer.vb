...
Partial Public NotInheritable Class sht_Report
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_Report", "sht_Report")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_Report As sht_Report
    
    Friend Shared Property sht_Report() As sht_Report
        Get
            Return _sht_Report
        End Get
        Set
            If (_sht_Report Is Nothing) Then
                _sht_Report = value
            Else
