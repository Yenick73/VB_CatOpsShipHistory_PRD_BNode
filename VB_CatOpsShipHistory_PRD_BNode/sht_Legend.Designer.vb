...
Partial Public NotInheritable Class sht_Legend
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_Legend", "sht_Legend")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_Legend As sht_Legend
    
    Friend Shared Property sht_Legend() As sht_Legend
        Get
            Return _sht_Legend
        End Get
        Set
            If (_sht_Legend Is Nothing) Then
                _sht_Legend = value
            Else
