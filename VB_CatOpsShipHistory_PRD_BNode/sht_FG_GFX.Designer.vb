...
Partial Public NotInheritable Class sht_FG_GFX
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_FG_GFX", "sht_FG_GFX")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_FG_GFX As sht_FG_GFX
    
    Friend Shared Property sht_FG_GFX() As sht_FG_GFX
        Get
            Return _sht_FG_GFX
        End Get
        Set
            If (_sht_FG_GFX Is Nothing) Then
                _sht_FG_GFX = value
            Else
