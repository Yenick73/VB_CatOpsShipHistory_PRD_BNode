...
Partial Public NotInheritable Class sht_FG_PNL
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_FG_PNL", "sht_FG_PNL")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_FG_PNL As sht_FG_PNL
    
    Friend Shared Property sht_FG_PNL() As sht_FG_PNL
        Get
            Return _sht_FG_PNL
        End Get
        Set
            If (_sht_FG_PNL Is Nothing) Then
                _sht_FG_PNL = value
            Else
