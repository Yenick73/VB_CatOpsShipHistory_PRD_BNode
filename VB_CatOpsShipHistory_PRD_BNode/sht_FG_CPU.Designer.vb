...
Partial Public NotInheritable Class sht_FG_CPU
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_FG_CPU", "sht_FG_CPU")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_FG_CPU As sht_FG_CPU
    
    Friend Shared Property sht_FG_CPU() As sht_FG_CPU
        Get
            Return _sht_FG_CPU
        End Get
        Set
            If (_sht_FG_CPU Is Nothing) Then
                _sht_FG_CPU = value
            Else
