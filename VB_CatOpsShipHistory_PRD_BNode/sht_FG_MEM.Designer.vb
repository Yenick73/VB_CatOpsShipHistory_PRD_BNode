...
Partial Public NotInheritable Class sht_FG_MEM
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "sht_FG_MEM", "sht_FG_MEM")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _sht_FG_MEM As sht_FG_MEM
    
    Friend Shared Property sht_FG_MEM() As sht_FG_MEM
        Get
            Return _sht_FG_MEM
        End Get
        Set
            If (_sht_FG_MEM Is Nothing) Then
                _sht_FG_MEM = value
            Else
